...
AC_CONFIG_FILES([fontforgeexe/Makefile])
AC_CONFIG_FILES([fontforgeexe/pixmaps/Makefile])
AC_CONFIG_FILES([fontforgeexe/pixmaps/2012/Makefile])
AC_CONFIG_FILES([fontforgeexe/pixmaps/tango/Makefile])
AC_CONFIG_FILES([fontforgeexe/collab/Makefile])
