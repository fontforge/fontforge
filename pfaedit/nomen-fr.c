...
static char str_Goto[] = "Aller au caractère";
...
static char str_MarkExtrema[] = "Marquer les Extremums";
...
static char *str_ShowAtt = "Montrer ATT";
...
static char str_ShowGridFitDDD = "Montrer ajustement grille...";
...
static char str_Merge[] = "Amalgamer point(s)";
...
static char str_Fontinfo[] = "Infos Police...";
...
static char str_OpenReference[] = "Open Référence";
...
static char str_AddExtrema[] = "Ajouter des Extremums";
...
static char str_RemoveVKern[] = "Effacer le crénage vertical";
...
static char str_TypoFeatures = "Fonctions Typo.";
static char mnemonic_TypoFeatures = 'T';
static char str_CopyFeatureToFont = "Copier Fonction(s) vers police...";
static char mnemonic_CopyFeatureToFont = 'C';
static char str_DefaultATT = "ATT par défaut";
static char mnemonic_DefaultATT = 'D';
static char str_RemoveAllFeatures = "Retirer toutes les fonctions";
static char mnemonic_RemoveAllFeatures = 'R';
static char str_RemoveUnusedNested = "Retirer imbrications inutilisées";
static char mnemonic_RemoveUnusedNested = 'I';
static char str_RemoveFeature = "Retirer Fonction(s)...";
static char mnemonic_RemoveFeature = 'F';
static char str_RetagFeature = "Retag Fonction(s)...";
...
static char str_CharName[] = "Nom du caractère";
static unichar_t mnemonic_CharName[] = 'N';
static char str_Autowidth[] = "Auto Largeur...";
static unichar_t mnemonic_Autowidth[] = 'A';
static char str_Removeallkern[] = "Effacer tout le Crénage";
static unichar_t mnemonic_Removeallkern[] = 'E';
static char str_RemoveAllVKern[] = "Effacer tout le Crénage Vertical";
static char str_VKernFromHKern = "CrénageV à partir du crénageH";
...
static char str_ChinesePacked = "Compact GB 2312 (Chinois)";
...
static char str_HistPopup[] = "dialogue Histogramme";
...
static char str_TagReuseLong = "Vous ne pouvez pas utiliser un tag qui set déjà dans une fonctionnalité imbriquée"
...
static char str_Contextual = "Contextuel";
static char str_ContextPos = "Pos Context";
static char str_ContextSub = "Subst Context";
static char str_ChainPos = "Pos Chaînée";
static char str_ChainSub = "Subst Chaînée";
static char str_ReverseChainSub = "Subst chaînée inverse";
static char str_EditDataDDD = "Éditer Données...";
static char str_NewContextPos = "Nouvelle Position Contextuelle";
static char str_NewContextSub = "Nouvelle Substitution Contextuelle";
static char str_NewChainPos = "Nouvelle Position Chaînée";
static char str_NewChainSub = "Nouvelle Substitution Chaînée";
static char str_NewReverseChainSub = "Nouvelle Substitution Chaînée inverse";
static char str_EditContextPos = "Éditer une position Contextuelle";
static char str_EditContextSub = "Éditer une substitution Contextuelle";
static char str_EditChainPos = "Éditer une Position Chaînée";
static char str_EditChainSub = "Éditer une Substitution Chaînée";
static char str_EditReverseChainSub = "Éditer une Substitution Chaînée inverse";
static char str_MacFeatures = "Fonctions pour Mac";
static char str_Order = "Ordre";
static char str_MacStateMachine = "Mac SM";
static char str_Indic = "Indo-Aryen";
static char str_ContextIns = "Context Ins";
static char str_NewIndic = "Nouveau Réarrangement Indo-Aryen";
static char str_EditIndic = "Éditer Nouveau Réarrangement Indo-Aryen";
static char str_NewInsert = "Nouvelle insertion conditionnelle de Glyphe";
static char str_EditInsert = "Éditer insertion conditionnelle de Glyphe";
...
static char *str_RQD = "Fonctions nécessaires"
...
static char *str_Top = "Tout en haut";
static char mnemonic_Top = 'H';
static char *str_Bottom= "Tout en bas";
static char mnemonic_Bottom= 'B';
static char *str_Up = "Haut";
static char mnemonic_Up = 'h';
static char *str_Down= "Bas";
...
static char *str_DesignSize = "Taille Design:";
static char *str_DesignSizePopup = "La taille (en points) pour laquelle cette police a été dessinée";
static char *str_Slant = "Inclinaison:";
static char *str_SlantPopup = "Dans une police italique, déplacement horizontal correspondant à un déplacement vertical de 1"
static char *str_Space = "Espace:";
static char *str_SpacePopup = "Espacement des mots lors de l'utilisation de cette police"
static char *str_Stretch = "Extension:";
static char *str_StretchPopup = "Espace supplémentaire maximum entre les mots avec cette police"
static char *str_Shrink = "Rétrécissement:";
static char *str_ShrinkPopup = "Espace maximum supprimable entre 2 mots, avec cette police"
static char *str_XHeightC = "hauteur X:";
static char *str_XHeightCPopup = "Hauteur des minuscules au sommet plat"
static char *str_Quad = "Carré:";
static char *str_QuadPopup = "Largeur d'un 'em'"
static char *str_ExtraSp = "Espace en +:";
static char *str_ExtraPopup = "Soit:\nEspace supplémentaire à ajouter à la fin d'une phrase\nOu espace à utiliser dans les formules mathématiques"
...
static char str_OptionsPopup = "pour optimiser les paramètres utilisés pour créer la police";
static char str_Outputafm[] = "Créer AFM";
static char str_Outputpfm[] = "Créer PFM";
static char str_Outputtfm[] = "Créer TFM & ENC";
...
static char *str_OutputTfmPopup = "Les fichiers tfm et enc contiennent les informations utilisées par TeX pour installer une police PostScript\256.";
...
static char str_Tfmfailedtitle[] = "Échec écriture du Tfm";
...
static char *str_PSHintsPopup = "Voulez vous que le fichier contienne les hints PostScript?"
static char *str_HintSubs = "Hint Substitution";
static char *str_FlexHints = "Flex Hints";
static char *str_FlexHintsPopup = "Voulez vous que le fichier contienne des honts flex PostScript?"
...
static char *str_PfaEditTable = "table PfaEdit";
static char *str_PfaEditTablePopup = "La table PfaEdit est une extension au formate TrueType\net contient diverses données utilisées par Pfaedit"
static char *str_PfEdComments = "Sauver les commentaires";
static char *str_PfEdCommentsPopup = "Sauver les commentaires des glyphes dans la table PfEd"
static char *str_PfEdColors = "Sauver les couleurs";
static char *str_PfEdColorsPopup = "Sauver les couleurs des glyphes dans la table PfEd"
    /* Goto character ... */
...
static char *str_Pair = "Paire";
static char *str_Subs = "Substitution";
...
static char *str_NewPair = "Nouvelle position de paire";
...
static char *str_EditPair = "Éditer le position de Paire";
...
static char str_Duppixelsizepre[] = "La police contiend déja des bitmaps de cette\ntaille (";
...
static char *str_PairedChar = "Caractères appairés";
static char *str_MissingPaired = "Caractère de paire manquant";
static char *str_NeedPaired = "Vous devez donner le nom du caractère auquel celui ci est apparié";
static char *str_PairedNotInFont = "Le nom du caractère d'appariement (%.50hs) ne se trouve pas dans la police. Maintenez vous ce choix?";
 /* Ligature feature tags */
static char str_RequiredLig   = "Ligatures Requises"
static char str_StandardLig   = "Ligatures Standards"
static char str_DiscretionaryLig = "Ligatures Discrétionnaires"
...
static char str_VerticalKerning = "Crénage Vertica";
...
static char str_ExpertForms = "Formes Expert";
...
static char str_JIS78Forms = "Formes JIS78";
static char str_JIS83Forms = "Formes JIS83";
static char str_JIS90Forms = "Formes JIS90";
...
static char str_PetiteCaps = "Lowercase to Petite Capitales";
...
static char str_TeXCharList = "Caractères pour TeX";
...
static char str_TerminalForms2 = "Extrémités, Formes #2";
static char str_TerminalForms3 = "Extrémités, Formes #3";
static char str_MedialForms2 = "Milieu, Formes 2";
...
static char str_ContextLig = "Ligatures Contextuelle";
static char str_ContextSwash = "Swash Contextuel";
 /* Script tags */
...
static char str_DFLT = "Défaut";
static char str_Deseret = "Déséret (Mormon)";
static char str_deva = "Dévanagârî";
static char str_EgyptianDemotic = "Démotique Égyptien";
static char str_EgyptianHieratic = "Hiératique Égyptien";
static char str_EgyptianHieroglyphs = "Hiéroglyphes Égyptiens";
static char str_ethi = "Éthiopien";
static char str_geor = "Géorgien";
static char str_Glagolitic = "Glagolithique";
static char str_Gothic = "Gothique";
static char str_grek = "Grec";
static char str_gujr = "Goudjarâtî";
static char str_guru = "Gourmoukhî";
static char str_jamo = "Hangûl Jamo";
static char str_hang = "Hangûl";
...
static char str_knda = "Kannara";
static char str_khmr = "Khmer";
static char str_lao = "Laotien";
...
static char str_Mayan = "Hiéroglyphes Mayas";
static char str_Meroitic = "Méroïtique";
static char str_mlym = "Malayâlam";
static char str_mong = "Mongol";
static char str_mymr = "Birman";
static char str_ogam = "Ogam";
static char str_orya = "Oriyâ";
static char str_Osmanya = "Osmanya";
static char str_Pahlavi = "Pehlavî";
static char str_Permic = "Ancien permien";
static char str_Phoenician = "Phénicien";
static char str_Phaistos = "Phaïstos";
...
static char str_thaa = "Thâna";
static char str_thai = "Thaï";
static char str_tibt = "Tibétain";
static char str_Ugaritic = "Ugaritique";
...
static char str_UncodedScript = "langues inécrites";
 /* Language tags */
...
static char str_OTFPashto = "Pachtou";
...
static char str_OTFSinhalese = "Cinghalais";
...
static char str_OTFVenda = "Vendéen";
...
static char str_EditLangList = " -- Édit. Script & Lang List --";
static char str_TagTooLong = "Marque trop longue";
static char str_TagMustBe4 = "La marque doit comporter 4 caractères";
...
static char str_MergeWithPopup = "PfaEdit va essayer de fusionner toutes les classes d'ancre ayant la même valeur pour \"Fusionner avec\", dans un seul GPOS lookup";
static char str_MarkToBaseLig = "Mark To Base, ou\nMark To Ligature";
static char str_MarkToMark = "Mark To Mark";
static char str_Cursive = "Cursive";
static char str_CursiveAttach = "Cursive Attachment";
  /* Select by att (pst) */
static char str_SimpSubstitution = "Substitutions simples"
static char str_AltSubstitutions = "Substitutions alternatives"
static char str_MultSubstitution = "Substitutions multiples"
static char str_SimpPos = "Position Simple"
static char str_PairPos = "Position de Paire"
static char str_LigCaret = "Ligature Caret"
static char str_Kerning = "Crénage"
static char str_VKerning = "Crénage V."
static char str_Containing = "Contenu:"
static char str_SelectResults = "Sélection des résultats";
static char str_SelectResultsPopup = "Sélectionner dans la fenêtre police les caractères\ntrouvés par cette recherche";
static char str_MergeResults = "Sélection augmentée";
static char str_MergeResultsPopup = "Étendre la sélection dans la fenêtre 'police' avec tous les caractères\ntrouvés par cette recherche";
static char str_RestrictSelection = "Sélection restreinte";
static char str_RestrictSelectionPopup = "Chercher seulement parmi les caractères sélectionnés, et déselectionner\nceux qui ne figurent pas dans le résultat de la recherche";
static char str_UnknownAnchorClass = "Classe d'ancre inconnue: %.70s";
static char str_TooManyTags = "Trop de tags spécifiés";
static char str_NoMatch = "Aucun caractère correspondant";
    /* Private Info */
...
static char *str_PrefsPopupFN[] = "Nom utilisé pour le champ 'Fondeur'\nlors de la création des polices BDF";
static char *str_PrefsPopupTFN[] = "Nom utilisé comme 'Identifiant Vendeur', pour\nla création des polices ttf (table OS/2).\nQuatre caractères maximum";
...
static char *str_PrefsPopupCH[] = "Lors du centrage d'un accent sur un caractère, l'accent doit-il être\ncentré par rapport au point le plus haut du caractère, ou par rapport\nau milieu du caractère?"
static char *str_PrefsPopupAA[] = "Pourcentage d'un 'em' dont les flèches de déplacement\nvont bouger le point sélectionné";
static char *str_PrefsPopupGN[] = "Adobe a affecté les noms Delta, Omega et Mu\nrespectivement à Increment, Ohm et Micro.\nCeci parait étrange aux typographes grecs qui\nutilisent ces noms pour désigner des lettres de l'alphabet.\nCocher ce flag fait que les caractères de l'alphabet seront\nappelés Delta.greek, Omega.greek et mu.greek.";
...
static char *str_PrefsPopupPPT[] = "PfaEdit peut utiliser 2 applications externes de vectorisation,\nautotrace et potrace\nSi votre système n'en a qu'une, pfaedit l'utilisera, mais si vous\navez les 2, 'On' privilégiera potrace (et 'Off' autotrace)."
...
static char *str_PrefsPopupMFA[] = "Paramètres à passer au programme 'mf' (metafont). Le nom de fichier sera mis après.";
...
static char *str_PrefsPopupMFE[] = "MetaFont (mf) produit beaucoup de verbiage sur stdout. La plupart du temps,\nc'est sans importance, sauf lorsque quelque chose se passe mal."
...
static char *str_PrefsPopupAGO = "Apple et MS/Adobe diffèrent quand au format des fichiers truetype et opentype.\nCeci pilote la valeur par défaut de la case à cocher 'OpenType' dans le menu 'créer polices'.\nLes principales différences sont:\n  Une spécification différente pour l'entrée 'postscript' dans la table 'name'\n  Les données Bitmap sont rangées dans des tables différentes\n  Les caractères composés mis à l'échelle sont traités différemment\n  Utilisation de GSUB à la place de morx(t)/feat\n  Utilisation de GPOS à la place de kern/opbd\n  Utilisation de GDEF à la place de lcar/prop\nSi cette case ET la case Apple sont cochées, les 2 formats sont créés"
static char *str_PrefsPopupUndo = "Nombre max de Défaire/Refaire stockés dans un caractère";
static char *str_PrefsPopupHLP = "Le répertoire de votre ordinateur dans lequel PfaEdit va rechercher ses fichiers d'aide.\nSi ce répertoire ne contient pas les fichiers attendus, Pfaedit cherchera sur Internet.";
static char *str_PrefsPopupSAJ = "Lorsque vous tirez des points dans la vue 'contour', une jonction\npeut se produire: 2 contours ouverts se touchent à leurs extrémités.\nSi cette case est à On, PfaEdit arrètera alors la sélection\n (comme si vous aviez relaché le bouton de la souris).\nC'est pratique si vos doigts ont un peu tendance à trembler."
...
static char *str_Features = "Caractéristiques";
static char *str_MappingB = "Répartition";
static char *str_Feature = "Fonctionnalité";
static char *str_FeatureId = "Code:";
static char mnemonic_FeatureId = 'o';
static char *str_Name = "Nom:";
static char mnemonic_Name = 'N';
static char *str_ThisFeatureCodeIsAlreadyUsed = "Cette fonction, code, est déjà utilisée";
...
static char *str_ThisSettingCodeIsAlreadyUsed = "Cette fonction, setting combination, est déjà utilisée";
static char *str_ThisSettingCodeIsAlreadyUsedReuse = "Cette fonction, setting combination est déjà utilisée\nVoulez vous vraiment vous en resservir?";
...
static char *str_CleanupSelfIntersectPopup = "Quand PfaEdit détecte qu'une courbe va se recouper avec elle même,\nalors mettre cette option à vrai lui fait essayer d'améliorer les choses\nen supprimant les intersections";
    /* Auto Width/Kern */
...
static char *str_RRRad="Rayon de l'arrondi du rectangle";
static char *str_WithinBoundingBox="Tracé selon boîte";
static char *str_CenterOut="Autour d'un centre";
static char *str_Polygon="Polygone";
static char *str_Star="Étoile";
static char *str_NumPSVert="Nb. sommets (étoile) ou cotés (polygone)";
...
static char *str_ShapeType = "Définition de la Forme";
/* Popups */
...
static char *str_SearchForCIDMap = "Cette police est basée sur le jeu de caractère %1$.20hs-%2$.20hs-%3$d, mais ce que j'ai trouvé de mieux c'est %1$.20hs-%2$.20hs-%4$d.\nUtiliserai-je cette valeur ou préférez vous chercher?";
...
static char *str_ProbTooManyPoints = "Il y a plus de points dans ce caractère que le maximum autorisé";
static char *str_ProbTooDeepRefs = "Il y a des références imbriquées dans ce caractère plus profondes qu'il n'est autorisé";
static char *str_ProbTooManyHints = "Il y a plus de hints dans ce caractère que la maximum autorisé";
...
static char *str_ProbIrrelCP = "Ce caractère contient des points de contrôle trop proches des points du tracé pour permettre de modifier la courbe";
static char *str_ProbBadSubs = "Ce caractère contient une substitution ou une ligature qui référence un caractère vide"
static char *str_ProbBadSubs2 = "'%2$c%3$c%4$c%5$c' fait référence à un caractère vide \"%1$.20hs\"";
static char *str_ProbExplain = "Explication des problèmes";
static char *str_GlyphPSTTag = "Le glyphe %1$.50hs avec %2$hs avec le tag '%3$c%4$c%5$c%6$c'";
static char *str_GlyphMacPSTTag = "Glyphe %1$.50hs avec %2$hs avec fonction <%3$d,%4$d>";
static char *str_FPSTKernTag = "%1$hs avec le tag '%2$c%3$c%4$c%5$c'";
static char *str_MacASMTag = "%1$hs avec fonction <%2$d,%3$d>";
static char *str_RefersToMissingGlyph = " référence un glyphe manquant"
static char *str_RefersToMissingLookup = " référence un lookup tag manquant"
static char *str_ReplaceWith = "Remplacer par:"
static char *str_Always = "Toujours"
static char *str_AlwaysPopup = "Toutes les occurences de ce nom de glyphe\ndoivent être remplacée comme indiqué ici"
...
static char *str_CheckFlippedRefs = "Vérifier les références retournées";
...
static char *str_MorePointsThan = "Nb max points:"
static char *mnemonic_MorePointsThan = 'p';
static char *str_MorePointsThanPopup = "le manuel de référence du Postscript (Appendix B) dit qu'un\ninterprèteur n'a pas besoin de supporter des chemins avec plus de 1500 points.\nJe pense que cela inclut les points de contrôle. Du point de vue du PostScript,\n tous les contours d'un caractère constituent UN chemin. Les intèrpréteurs\nmodernes ont tendance à supporter plus que cette limite.\n(Attention, le nombre de points d'une police Truetype après conversion en PS\nsera doublé)";
static char *str_RefsDeeperThan = "Imbrication max:"
static char *mnemonic_RefsDeeperThan = 'd';
static char *str_RefsDeeperThanPopup = "La description de référence des chaines de Type 2 (Annexe B) dit que\nles sous-programmes ne doivent pas avoir plus de 10 niveaux d'imbrication.\nChaque niveau d'imbrication des réferences utilise un niveau de sous-programme,\net les hints peuvent encore utiliser un autre niveau.";
static char *str_MoreHintsThan = "Nb max hints:"
static char *mnemonic_MoreHintsThan = 'h';
static char *str_MoreHintsThanPopup = "La description de référence des chaines de Type 2 (Annexe B) dit qu'il\nne peut pas y avoir plus de 96 hints horizontaux ou verticaux dans un\ncaractère.";
...
static char *str_MissingGlyphPopup = "Vérifie si une substitution, une classe de crénage, etc,\nutilise un nom de glyphe qui n'existe pas dans la police"
static char *str_MissingLookupTag = "Vérifier les tags de recherche manquants";
static char *mnemonic_MissingLookupTag = 't';
static char *str_MissingLookupTagPopup = "Vérifie si un élément dans une substitution contextuelle ou\npositionelle référence un élément manquant dans la police"
static char *str_IrrelevantFactor = "Coeff. pertinence:";
static char mnemonic_IrrelevantFactor = 'F';
static char *str_IrrelevantFactorPopup = "Un point de contrôle est non-pertinent si la distance entre lui et son point extême\nest moins de la distance entre les 2 points extrêmes divisée par ce facteur";
...
static char *str_SubsToEmptyChar = "Vérifier les substitutions par des caractères vides";
static char *str_SubsToEmptyCharPopup = "Chercher les caractères contenant des entrées 'GSUB' pointant vers des caractères vides"
	/* Meta font */
...
static char *str_SavingOpenTypeFont = "Enregistrer la police OpenType";
static char *str_LoadBitmapFonts = "Charger police bitmap?";
...
static char *str_ExtraneousSingleByte = "Il y a un caractère sur un octet (%d) utilisant un emplacement pour les caractères à deux octet";
...
static char *str_NoEncodedChars = "Aucun caractère encodé";
static char *str_NoUnicodeEncoding = "Cette police ne contient aucun caractère avec un encodage Unicode.\nLe résultat ne sera probablement pas utilisable.";
static char *str_NoUnicodeEncodingUseSymbol = "Cette police ne contient aucun caractère avec un encodage Unicode.\nVoulez vous utiliser un encodage \"Symbol\"  à la place de l'Unicode?";
	/* tottfgpos */
static char *str_MultipleLookup = "Recherches Multiples";
static char *str_MultipleLookupLong = "Des recherches multiples  ont été produites pour le point d'ancrage '%s', une seule sera utilisée";
static char *str_MissingLookup = "Recherche Manquante";
static char *str_MissingLookupLong = "Une recherche imbriquée pour le tag '%s' n'a pas été trouvée. La police ainsi créée ne sera pas utilisable. Essayez Element->Rechercher Problèmes"
	/* Spline Fill */
...
static char *str_GlyfAndCFF = "Cette police contient à la fois une table TrueType 'glyf' et une table OpenType 'CFF '. PfaEdit ne peut en utiliser qu'une à la fois, aussi il faut choisir:";
    /* sfd */
...
static char *str_Width = "Largeur";
static char mnemonic_Width = 'L';
static char *str_WidthC = "Largeur:";
static char mnemonic_WidthC = 'L';
static char *str_WidthDDD = "Largeur...";
...
static char *str_RotateSkewWarning = "Après une rotation ou une transformation de caractère, vous devriez probablement refaire Element->Ajouter Extremum";
    /* scripting */
...
static char *str_CurveSmoothingPopup = "Simplifier examine les points angulaires dont les points de contrôle\nsont presque colinéaires, et les adoucit en points courbes"
static char *str_IfTan = "si tangeante < à"
static char *str_SnapToHV = "Arrondi horizontal/vertical";
static char mnemonic_SnapToHV = 'n';
static char *str_SnapToHVPopup = "Si la pente d'un point ajusté est quasi horizontale ou verticale\narrondir à la droite"
...
static char *str_ExitDebugger = "sortir du Debugger"
    /* showatt */
static char *str_NoAdvancedTypography = "Pas de typographie avancée";
...
static char *str_SetFromSelectionPopup = "Utiliser cette classe pour sélectionner les caractères dans la vue 'police'";
static char *str_Select_nom = "Sélectionner";
static char *str_SelectFromClassPopup = "Les caractères sélectionnés dans la vue 'police' deviennent les caractères de cette classe";
static char *str_KernOffset = "Valeur du crénage:";
static char *str_AlreadyUsed = "Déjà utilisé";
static char *str_AlreadyInClass = "Ce caractère %.30hs est déjà dans une autre classe. Voulez vous le supprimer de l'autre classe, ou de celle ci?"
static char *str_FromOld = "De l'autre";
static char *str_FromThis = "De celle ci";
static char *str_SelectAScript="Sélectionnes un script svp";
...
static char *str_ClassZeroOffsets = "Les paires de crénage pour la classe 0 (\"Tout le reste\") devraient toujours être à 0"
    /* nonlineartrans */
static char *str_BadToken = "Mot clef incorrect";
static char *str_BadNameToken = "Mot clef \"%.30hs\" incorrect\naprès ...%40hs";
static char *str_BadTokenExpected = "Mot clef incorrect. Attendu \"%.10hs\" trouvé \"%.10hs\"\nprès de ...%40hs";
static char *str_BadTokenExpectedChar = "Mot clef incorrect. Attendu \"%.10hs\"\nprès de ...%40hs";
static char *str_BadTokenChar = "Mot clef incorrect. trouvé \"%c\"\nprès de ...%40hs";
static char *str_UnexpectedToken = "Mot clef inattendu.\ndevant ...%40hs";
static char *str_UnexpectedTokenAtEnd = "Mot clef inattendu en fin d'expression.\ndevant ...%40hs";
...
static char *str_Outlining = "'Contournage' des caractères";
static char *str_Inlining = "'Inlining' des caractères";
static char *str_Shadowing = "Ombrage des caractères";
...
static char *str_StemHistPopup = "Largeur: %d\nNombre: %d\nPourcentage du Max: %d%%\n";
static char *str_StemHistSumPopup = "Largeur: %d-%d (%d)\nNombre: %d (%d)\nPourcentage du Max: %d%%\n";
static char *str_BlueHistPopup = "Position: %d\nNombre: %d\n";
static char *str_BlueHistSumPopup = "Position: %d-%d (%d)\nNombre: %d (%d)\n";
static char *str_BlueMsg = "Les valeurs Bleues vont par paires. Sélectionnez en une autre.";
static char *str_SmallerNumberFirstInBlues = "Le nombre le plus petit doit être sélectionné en premier dans une paire de valeurs bleues";
static char *str_TinySelection = "petite sélection";
static char *str_TinySelectionFull = "Il y a trop peu de caractères sélectionnés, à mon avis,\npour calculer l'aspect de la police de manière significative. Si vous\ndéselectionnez tout, cette commande sera appliquée à tous les caractères";
    /* contextchain */
static char *str_ByGlyphs = "Par Glyphes";
static char *str_ByClasses = "Par Classes";
static char *str_ByCoverage = "Par Couvertures";
static char *str_Match = "Coïncide";
static char *str_Backtrack = "Backtrack";
static char *str_Lookahead = "Lookahead";
static char *str_RuleCnt = "Nb règles:";
static char *str_CurrentRule = "Règle Courante:";
static char *str_SetGlyphsFromSelectionPopup = "Sélectionne dans la vue 'police' les glyphes de cette liste";
static char *str_SelectFromGlyphsPopup = "Prendre les caratères sélectionnés dans la vue 'police' pour contenu de cette liste";
...
static char *str_OTCCSubFormat1 = "Dans OpenType, les tables secondaires contextuelles ou de chaînage peuvent prendre 3 formes"
...
static char *str_OTCCSubFormat5 = "PfaEdit supporte seulement l'édition des formes 1 et 3.";
...
static char *str_OTCCSubFormat9 = "Pour chaîner les tables secondaires vous devez spécifier des listes de chaînage avant et"
static char *str_OTCCSubFormat10= " arrière."
...
static char *str_BadGlyphList = "Liste de glyphes de coïncidence incorrecte";
static char *str_BadMatchGlyphLong = "Une liste de glyphes doit contenir au moins un nom de glyphe,\net les noms de glyphes doivent être des noms postscript valides";
static char *str_BadBackGlyphList = "Liste de glyphes de chaînage arrière incorrecte";
static char *str_BadForeGlyphList = "Liste de glyphes de chaînage avant incorrecte";
static char *str_BadGlyphNameListLong = "Les noms de glyphes doivent être des noms postscript valides";
static char *str_BadSeqLookup = "Liste de Sequence/Recherche incorrecte"
static char *str_MissingSeqLookup = "Il doit y avoir au moins une entrée dans la liste de Sequence/Recherche"
...
static char *str_MatchCntWrong = "Dans une chaîne de substitution inverse, il doit y avoir exactement une table de couverture qui corresponde";
static char *str_ReplacementMismatch = "Dans une chaîne de substitution inverse, il doit y avoir exactement autant de remplacements qu'il y a de noms dans la table de couverture correspondante";
static char *str_RplMismatch = "Erreur de remplacement";
static char *str_Sequence = "Numéro de Séquence:";
static char *str_Classes = "Classes";
static char *str_SeqLookup = "Séquence/Recherche";
static char *str_SeqLookList= "une liste ordonnée de suite de positions et de tags de recherche"
...
static char *str_ClassListOfListsOfGlyphNames = "Classes (listes des listes de nom de glyphes)";
...
static char *str_MatchClass = "Classes de coïncidence";
static char *str_BacktrackClass = "Classes Avants";
static char *str_LookaheadClass = " Classes Arrières";
static char *str_EndOfText = "{Fin du Texte}";
static char *str_EverythingElse = "{n'importe quoi d'autre}";
static char *str_DeletedGlyph = "{Glyphe supprimé}";
static char *str_EndOfLine = "{Fin de Ligne}";
...
static char str_NoGlyphNamed = "Il n'y a pas de glyphe \"%.20hs\" dans cette police,\nest ce exprès?";
static char *str_BadClassNumber = "Numéro de classe de coïncidence incorrect";
static char *str_BadBackClassNumber = "Numéro de classe de chïnage arrière incorrect";
static char *str_BadLookClassNumber = "Numéro de classe de chïnage avant incorrect";
...
static char str_MacLithuanian = "Lithuanien";
...
static char str_MacUzbek = "Ouzbek";
static char str_MacKazakh = "Kazakh";
static char str_MacAxerbaijaniC = "Aséri (Cyrillique)";
static char str_MacAxerbaijaniA = "Aséri (Arabe)";
...
static char str_MacPashto = "Pachtou";
...
static char str_MacSanskrit = "Sanscrit";
...
static char str_MacSinhalese = "Cinghalais";
static char str_MacBurmese = "Birman";
static char str_MacKhmer = "Khmer";
static char str_MacLao = "Laotien";
static char str_MacVietnamese = "Vietnamien";
static char str_MacIndonesian = "Indonésien";
static char str_MacTagalog = "Tagalog";
static char str_MacMalayR = "Malais (romain)";
...
static char str_MacJavanese = "Javanais (romain)";
static char str_MacSundanese = "Sondanais (romain)";
...
static char str_MacIrishDot = "Gaélique irlandais (avec dot)";
static char str_MacTongan = "Tongan";
static char str_MacGreekPolytonic = "Grec (polytonal)";
static char str_MacGreenlandic = "Groenlandais";
static char str_MacAzebaijani = "Azéri (romain)";
...
static char *str_MutuallyExclusive = "s'excluent mutuellement";
static char *str_Enabled = "Activé";
static char mnemonic_Enabled = 'A';
static char *str_ThisSettingIsAlreadyUsed = "Ce réglage est déjà utilisé";
    /* apple statemachine */
static char *str_FeatureSetting = "Fonction, Réglage:";
...
static char *str_CurrentGlyphIsKashida = "Le glyphe courant semble Kashida";
static char *str_MarkedGlyphIsKashida = "Le glyphe marqué semble Kashida";
...
static char *str_BadFeatureSetting = "Fonction mal employée";
static char *str_FeatureSettingFor = "Fonction/Emploi pour:";
static char *str_VerticalOnly = "Seulement Vertical";
...
static char *str_NoFeaturesRemoved = "Aucune fonction otée";
static char *str_NoFeaturesCopied = "Aucune fonction copiée";
static char *str_NoFeaturesRetagged = "No Features Retagged";
static char *str_AnyFlags = "N'importe quels Flags";
static char *str_TheseFlags = "Ces Flags";
static char *str_AnyScript = "N'importe quel Script";
static char *str_BadTag = "Tag incorrect";
static char *str_RetagWith = "Retag avec...";
static char *str_NoSelectedFont = "Pas de police sélectionnée";
