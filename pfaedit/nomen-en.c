...
static char *str_GlyphClass = "Glyph Class:";
...
static char *str_EndOfText = "{End of Text}";
static char *str_EverythingElse = "{Everything Else}";
static char *str_DeletedGlyph = "{Deleted Glyph}";
static char *str_EndOfLine = "{End of Line}";
