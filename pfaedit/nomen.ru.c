...
static char *str_StrokeVar ="Stroke Variation"; /*new*/
...
static char *str_OTFFamily = "Preferred Family"; /*new*/
static char *str_OTFStyles = "Preferred Styles"; /*new*/
static char *str_CompatableFull = "Compatable Full"; /*new*/
static char *str_SampleText = "Sample Text"; /*new*/
...
static char str_Enternameofchar[] = "Enter the name of a character in the font"; /*new*/
static char str_Couldntfindchar[] = "Could not find the character: "; /*new*/
  /* Font has changed dlg */
static char str_Dontsave[] = "Don't Save"; /*new*/
static unichar_t mnemonic_Dontsave[] = 'D'; /*new*/
...
static char str_Toomany[] = "This involves opening more than 10 windows.\012Is that really what you want?"; /*new*/
...
static char str_Buildingaccented[] = "Building accented letters"; /*new*/
static char str_Replacearing[] = "Replace е"; /*new*/
...
static char *str_PossiblyTooBig = "Value possibly out of range"; /*new*/
  /* Import */
...
static char *str_Caligraphic = "Caligraphic"; /*new*/
...
static unichar_t str_stdCharRange[] = { 'A-Za-z0-9', '\0' }; /*new*/
static char *str_Selected = "Selected"; /*new*/
static char *str_Spacing = "Spacing"; /*new*/
static char *str_TotalKerns = "Всего пар:";
static char *str_Threshold = "Предел:";
static char *str_NoCharsSelected = "No characters selected."; /*new*/
  /* Auto Trace */
static char *str_NothingToTrace = "Нечего трассировать";
static char *str_NoAutotrace = "Can't find autotrace"; /*new*/
static char *str_NoAutotraceProg = "Can't find autotrace program (set AUTOTRACE environment variable)"; /*new*/
...
static char *str_RemovingSize = " Removing a size will delete it."; /*new*/
static char *str_AddingSize = " Adding a size will create it."; /*new*/
...
static char *str_PointSizes75 = "Point sizes on a 75 dpi screen"; /*new*/
static char *str_PointSizes100 = "Point sizes on a 100 dpi screen"; /*new*/
static char *str_PointSizes96 = "Point sizes on a 96 dpi screen"; /*new*/
static char *str_PointSizes120 = "Point sizes on a 120 dpi screen"; /*new*/
static char *str_PointSizes72 = "Point sizes on a 72 dpi screen"; /*new*/
...
static char *str_RecalculateBitmaps = "Recalculate Bitmaps"; /*new*/
  /* BV Edit */
...
static char *str_InvalidBits = "The only valid values for bits/pixel are 1, 2, 4 or 8"; /*new*/
  /* CV Images */
static char *str_CantFindFile = "Can't find the file"; /*new*/
static char *str_BadXFigFile = "Bad xfig file"; /*new*/
static char *str_BadImageFile = "Bad image file"; /*new*/
static char *str_BadImageFileName = "Bad image file: %.100hs"; /*new*/
static char *str_BadImageFileNotBitmap = "Bad image file, not a bitmap: %.100hs"; /*new*/
static char *str_NothingLoaded = "Nothing Loaded"; /*new*/
static char *str_NothingSelected = "Nothing Selected"; /*new*/
static char *str_MoreImagesThanSelected = "More Images Than Selected Characters"; /*new*/
...
static char *str_IsEdit="Is Layer Editable?"; /*new*/
static char *str_IsVis="Is Layer Visible?"; /*new*/
...
static char *str_NoVerticalMetrics = "No Vertical Metrics"; /*new*/
...
static char *str_ProbXNear = "The x coord of the selected point is near the specified value"; /*new*/
static char *str_ProbYNear = "The y coord of the selected point is near the specified value"; /*new*/
static char *str_ProbYBase = "The y coord of the selected point is near the baseline"; /*new*/
static char *str_ProbYXHeight = "The y coord of the selected point is near the xheight"; /*new*/
static char *str_ProbYCapHeight = "The y coord of the selected point is near the cap height"; /*new*/
static char *str_ProbYAs = "The y coord of the selected point is near the ascender height"; /*new*/
static char *str_ProbYDs = "The y coord of the selected point is near the descender height"; /*new*/
static char *str_ProbLineHor = "The selected line segment is nearly horizontal"; /*new*/
static char *str_ProbLineVert = "The selected line segment is nearly vertical"; /*new*/
static char *str_ProbLineItal = "The selected line segment is near the italic angle"; /*new*/
...
static char *str_Points2Close = "Points too close"; /*new*/
...
static char *str_LineStd = "Edges near horizontal/vertical"; /*new*/
...
static char *str_CounterTooSmall = "A counter was requested to be too small, it has been pegged at its minimum value"; /*new*/
static char *str_Simple = "Simple"; /*new*/
static char *str_Advanced = "Advanced"; /*new*/
static char *str_Embolden = "Embolden"; /*new*/
static char *str_Condense = "Condense"; /*new*/
static char *str_Expand = "Expand"; /*new*/
