...
static char *str_SvgNoImages = "This font contains at least one translucent layer, but type3 does not support that (anything translucent or transparent is treated as opaque). Do you want to proceed anyway?";
...
static char *str_PrefsPopupPPT[] = "PfaEdit supports two different helper applications to do autotracing\n autotrace and potrace\nIf your system only has one it will use that one, if you have both\nuse this option to tell pfaedit which to pick."
...
static char *str_OTCCSubFormat5 = "PfaEdit only supports editing the first and third formats.";
static char *str_OTCCSubFormat6 = " In the first format you must specify a string of glyph-names."
...
static char *str_AxisWeights = "Position of this design along each axis"
...
static char *str_DisorderedDesignsOk = "The master designs are not positioned in the expected order. PfaEdit will be unable to suggest a ConvertDesignVector for you. Is this what you want?"
