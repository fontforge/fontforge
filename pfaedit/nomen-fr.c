...
static char str_SimplifyMore[] = "SimpliferPlus";
...
static char *str_TTFNames = "TTF Nom";
static char *str_TTFValues = "TTF Valeurs";
...
static char *str_FlippedRef = "Référence Abimée";
static char *str_FlippedRefUnlink = "%.50hs contains a flipped reference. Cela ne peut pas être corrigé en l'état. Voulez vous que Pfaedit le délie et corrige ensuite?";
...
static char *str_Generic[] = "Générique";
...
static char *str_bvat = " à ";
static char *str_bvfrom = " venant de ";
...
static char *str_popKnife = "Scinder la splines";
...
static char *str_ProbMissingExtreme = "La courbe spline sélectionnée n'a pas de point à au moins l'une de ses extrémités";
...
static char *str_ProbHint3Width = "Ce hint a une largeur incorrecte pour un hint stem3";
static char *str_ProbHint3Spacing = "Les compteurs entre ces hints n'ont pas exactement la même taille, ce qui ne convient pas pour un hint stem3";
static char *str_ProbHint3Four = "Ce caractère a 4 hints, mais en enlevant celui ci, cela conviendrait pour un hint stem3"
static char *str_NoProbHint3 = "Ce caractère peut utiliser un hint stem3";
...
static char *str_ProbAboveOdd = "Le point de contrôle au dessus du point sélectionné est en dehors\ndu segment de la spline";
static char *str_ProbBelowOdd = "Le point de contrôle au dessous du point sélectionné est en dehors\ndu segment de la spline";
static char *str_ProbRightOdd = "Le point de contrôle à droite du point sélectionné est en dehors\ndu segment de la spline";
static char *str_ProbLeftOdd  = "Le point de contrôle à gauche du point sélectionné est en dehors\ndu segment de la spline";
...
static char *str_CpOdd = "Points de contrôle en dehors de la spline";
...
static char *str_Hint3 = "Presque un hint stem3";
static char *mnemonic_Hint3 = '3';
static char *str_Hint3Popup = "Regarde si ce caractère est presque, mais pas exactement,\nconforme aux spécifications d'un hint stem3.\nC'est à dire, soit verticalement soit horizontalement, il doit y avoir\nexactactement 3 hints, de même largeur, et\nespacés régulièrement."
static char *str_ShowExactHint3 = "Montrer les *stem3 exacts";
static char *mnemonic_ShowExactHint3 = 'S';
static char *str_ShowExactHint3Popup = "Montrer si ce caractère est exactement un hint stem3";
static char *str_CheckDirection = "Vérifier que les chemins extérieurs vont dans le sens horaire";
...
static char *str_PointsNear = "2 Points sont \"Proches\" si ils sont à moins de ";
...
static char *str_CounterTooSmallT = "Compteur trop petit";
static char *str_CounterTooSmall = "Le compteur demandé était trop petit, il a été augmenté à sa valeur minimum";
