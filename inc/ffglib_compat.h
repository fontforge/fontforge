 ...
 * Returns: dest
 */
char *ff_ascii_formatd(char *dest, size_t dest_len, const char *format, double value);
 ...
 */
char *ff_uri_unescape_string(const char *escaped, const char *illegal_characters);
...
FFArray *ff_array_sized_new(int zero_terminated, int clear, size_t element_size, size_t initial_capacity);
