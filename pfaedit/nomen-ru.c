...
static char *str_PrefsAppNotice1 = "Обычно PfaEdit ищет приложения просматривая содержимое каталогов перечисленных";
static char *str_PrefsAppNotice2 = "в переменной PATH.";
static char *str_PrefsAppNotice3 = "Вы можете указать полный путь к приложениям использующимся в PfaEdit.";
static char *str_PrefsAppNotice4 = "PfaEdit распознаёт BROWSER, MF и AUTOTRACE.";
