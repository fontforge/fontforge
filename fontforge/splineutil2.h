...
extern void SplineCharBalance(SplineChar *sc, SplineSet *head, int force_balancing);
...
extern void SplineSetBalance(SplineChar *sc, SplineSet *ss, int force_balancing);
