...
This is a modified version of that bundled with CMake. At the time of
writing, it is based on the version bundled with 3.14.5.

It has been modified to include pkg-config results in the hints, and it
also fixes the version detection, which is broken on some platforms.
...
elseif(EXISTS "${FREETYPE_INCLUDE_DIR_ft2build}/freetype/freetype.h")
  set(FREETYPE_H "${FREETYPE_INCLUDE_DIR_ft2build}/freetype/freetype.h")
elseif(EXISTS "${FREETYPE_INCLUDE_DIR_ft2build}/freetype.h")
  set(FREETYPE_H "${FREETYPE_INCLUDE_DIR_ft2build}/freetype.h")
endif()
