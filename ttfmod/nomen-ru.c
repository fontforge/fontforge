...
static char str_ShowInstrs[] = "Показать инструкции";
static unichar_t mnemonic_ShowInstrs[] = 'I';
static char str_HideInstrs[] = "Скрыть инструкции";
...
static char str_ShowFore[] = "Показать сплайны";
static unichar_t mnemonic_ShowFore[] = 'S';
static char str_HideFore[] = "Скрыть сплайны";
...
static char str_ShowRaster[] = "Показать растр";
static unichar_t mnemonic_ShowRaster[] = 'r';
static char str_HideRaster[] = "Скрыть растр";
...
static char *str_TtfMod = "TtfMod";
    /* ttfview.c */
static char *str_OpenTtf = "Открыть TTF...";
static char *str_TabMod = "Невозможно исправить изменённую таблицу"
static char *str_TabModNotBinary = "Эта таблица была изменена таким образом что\nдвоичный редактор не может редактировать\nеё пока вы не сохраните файл.\nХотите сохранить файл сейчас?";
static char *str_ReallyRevert = "Действительно восставновить старую версию?";
static char *str_RevertFailed = "Сбой восстановления!";
static char *str_FontChanged = "Шрифт изменён";
static char *str_FontChangedSave = "Шрифт %.100s был изменён.\nХотите сохранить его?";
static char *str_FontChangedSavem = "Файл содержащий шрифт %.100s был изменён.\nХотите сохранить его?";
static char *str_TablesOpen = "Открытые таблицы";
...
static char *str_Tbl_prop = "Свойства";
...
/* OS/2 */
static char *str_General = "Общие";
static char *str_Alignment = "Выравнивание";	/* Super/Subscript/Strikeout */
static char *str_Panose = "Panose";
static char *str_Charsets = "Наборы символов";
static char *str_AvgWidth = "Средняя ширина:"
static char *str_UltraCondensed = "Ультраузкий (50%)"
static char *str_ExtraCondensed = "Экстраузкий (62.5%)"
...
static char *str_IBMFamily = "Семейство IBM:"
static char mnemonic_IBMFamily = 'I';
static char *str_NoClassification = "Без классификации";
...
static char *str_VendorID = "Идентификатор производителя:";
static char *mnemonic_VendorID = 'V';
static char *str_UnicodeRanges = "Диапазоны Unicode"
static char *mnemonic_UnicodeRanges = 'U';
static char *str_BasicLatin = "Основная латиница 0000-007f";
...
static char *str_UGreek = "Греческий 0370-03FF";
static char *str_GreekSymCoptic = "Устаревшие греческие символы & Coptic";
static char *str_Cyrillic = "Кириллица 0400-052F";
static char *str_Armenian = "Армянский 0530-058F";
static char *str_UHebrew = "Иврит 0590-05FF";
static char *str_HebrewExtended = "Obsolete Extended Hebrew";
static char *str_UArabic = "Арабский 0600-06FF";
static char *str_ArabicExtended = "Obsolete Extended Arabic";
static char *str_Devanagari = "Деванагари 0900-097F";
static char *str_Bengali = "Бенгали 0980-09FF";
...
static char *str_Georgian = "Грузинский 10A0-10FF";
...
static char *str_Punctuation = "Пунктуация 2000-206F";
static char *str_SubSuperscripts = "Sub/Super scripts 2070-209F";
static char *str_Currency = "Валюта 20A0-20CF";
...
static char *str_Arrows = "Стрелки 2190-21FF";
static char *str_MathOpers = "Матем.операции 2200-22FF";
...
static char *str_GeometricShapes = "Геометрические фигуры 25A0-25FF";
static char *str_MiscSymbols = "Разные символы 2600-267F";
static char *str_Dingbats = "Dingbats 2700-27BF";
static char *str_CJKSymPunct = "CJK Symbols & Punct 3000-303F";
static char *str_Hiragana = "Хирагана 3040-309F";
static char *str_Katakana = "Катакана 30A0-30FF";
...
static char *str_Tibetan = "Тибетский 0F00-0FFF";
static char *str_Syriac = "Сирийский 0700-074F";
...
static char *str_Ethiopic = "Эфиопский 1200-12FF";
static char *str_Cherokee = "Чероки 13A0-13FF";
static char *str_UnitedCanSyl = "United Canadian Syllabics 1400-167F";
static char *str_Ogham = "Ogham 1680-169F";
static char *str_Runic = "Рунический 16A0-16FF";
static char *str_Khmer = "Кхмерский 1780-17FF";
static char *str_Mongolian = "Монгольский 1800-18AF";
static char *str_Braille = "Брайля 2800-28FF";
...
static char *str_Selection = "Выделение:";
static char *str_Italic = "Наклонный";
static char *str_Underscore = "Underscore";
static char *str_Negative = "Negative";
static char *str_Outlined = "Контурный";
static char *str_Strikeout = "Strikeout";
static char *str_Regular = "Обычный";
static char *str_CodePages = "Кодовые страницы:";
static char *str_CPLatin1 = "1252 Latin1";
static char *str_CPLatin2 = "1250 Latin2";
static char *str_CPCyrillic = "1251 Кириллица";
static char *str_CPGreek = "1253 Греческий";
static char *str_CPTurkish = "1254 Турецкий";
static char *str_CPHebrew = "1255 Иврит";
static char *str_CPArabic = "1256 Арабский";
static char *str_CPBaltic = "1257 Балтийский";
static char *str_CPVietnamese = "1258 Вьетнамский";
static char *str_CPThai = "874 Тайский";
static char *str_CPJapan = "932 JIS/Japan";
static char *str_CPSimplifiedChinese = "936 Упрощённый китайский";
static char *str_CPWansung = "949 Korean Wansung";
static char *str_CPTraditionalChinese = "950 Традиционный китайский";
...
static char *str_ApJapanese = "Японский";
static char *str_ApChinese = "Китайский";
static char *str_ApKorean = "Корейский";
static char *str_ApArabic = "Арабский";
static char *str_ApHebrew = "Иврит";
static char *str_ApGreek = "Греческий";
static char *str_ApRussian = "Русский";
static char *str_ApRSymbol = "RSymbol";
static char *str_ApDevanagari = "Деванагари";
static char *str_ApGurmukhi = "Gurmukhi";
static char *str_ApGujarati = "Gujarati";
static char *str_ApOriya = "Oriya";
static char *str_ApBengali = "Бенгали";
...
static char *str_ApGeorgian = "Грузинский";
static char *str_ApArmenian = "Армянский";
static char *str_ApMaldivian = "Maldivian";
static char *str_ApTibetan = "Tibetan";
static char *str_ApMongolian = "Монгольский";
static char *str_ApGeez = "Geez";
static char *str_ApSlavic = "Slavic";
static char *str_ApVietnamese = "Вьетнамский";
static char *str_ApSindhi = "Sindhi";
static char *str_Uninterpreted = "Uninterp";
    /* Apple Language list */
static char *str_ApEnglish = "Английский";
static char *str_ApFrench = "Французский";
static char *str_ApGerman = "Немецкий";
static char *str_ApItalian = "Итальянский";
static char *str_ApDutch = "Голандский";
static char *str_ApSwedish = "Шведский";
static char *str_ApSpanish = "Испанский";
static char *str_ApDanish = "Датский";
static char *str_ApPortuguese = "Португальский";
static char *str_ApNorwegian = "Норвежский";
static char *str_ApFinnish = "Финский";
static char *str_ApIcelandic = "Исландский";
static char *str_ApMaltese = "Maltese";
static char *str_ApTurkish = "Турецкий";
static char *str_ApYugoslavian = "Югославский";
static char *str_ApUrdu = "Урду";
static char *str_ApHindi = "Хинди";
    /* MS Language list */
...
static char *str_Byelorussian = "Белорусский be_BY";
static char *str_Bulgarian = "Болгарский bg_BG";
static char *str_Catalan = "Каталанский ca";
...
static char *str_Flemish = "Бельгийский nl_BE";
...
static char *str_FRFrench = "FranГais FranГais fr_FR";
static char *str_BEFrench = "FranГais Belgique fr_BE";
static char *str_CAFrench = "FranГais Canadien fr_CA";
static char *str_CHFrench = "FranГais Suiss fr_CH";
static char *str_LUFrench = "FranГais de Luxembourg fr_LU";
static char *str_DEGerman = "Deutsch Deutsch de_DE";
static char *str_CHGerman = "Schweizer Deutsch de_CH";
static char *str_ATGerman = "жsterreichisch Deutsch de_AT";
...
static char *str_SubFamily = "Подсемейство";
...
static char *str_16bit = "16 бит";
static char *str_32bit = "32 бит";
...
static char *str_MaxMemType1 = "Макс.:";
static char *str_MinMemType1 = "Min Memory (Type1):";
static char *str_MaxMemType42 = "Макс.:";
...
static char *str_UnderlineHeight = "Размер:";
...
static char *str_PostEncLost = "Кодировка будет потеряна";
...
static char *str_BadPSNameEmpty = "Необходимо указать название";
...
static char *str_CantCreate="Невозможно создать файл";
static char *str_CantCreateFile="Невозможно создать файл: %.100hs";
static char *str_SaveFailed="Сбой сохранения!";
static char *str_SaveFailedOn="Сбой при попытке сохранения %.100hs.";
