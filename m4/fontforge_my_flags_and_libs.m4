...
my_cflags="${my_cflags} ${FONTCONFIG_CFLAGS}"
...
test x"${i_do_have_pango}" = xyes && my_libs="${my_libs} ${PANGO_LIBS}"
test x"${i_do_have_pango}" = xyes -a x"${i_do_have_cairo}" = xyes && my_libs="${my_libs} ${PANGOCAIRO_LIBS}"
test x"${i_do_have_pango}" = xyes && my_libs="${my_libs} ${PANGOXFT_LIBS}"
