...
function(set_font_family type value)
  if("${type}" STREQUAL "sans")
    if("${value}" STREQUAL "default")
      if(APPLE)
        set(CMAKE_SANS_FAMILIES "sans,apple" PARENT_SCOPE)
      elseif(WIN32 OR CYGWIN)
        set(CMAKE_SANS_FAMILIES "sans,windows" PARENT_SCOPE)
      else()
        set(CMAKE_SANS_FAMILIES "sans,other" PARENT_SCOPE)
      endif()
    else()
      set(CMAKE_SANS_FAMILIES "${value}" PARENT_SCOPE)
    endif()
  elseif("${type}" STREQUAL "serif")
    if("${value}" STREQUAL "default")
      if(APPLE)
        set(CMAKE_SERIF_FAMILIES "serif,apple" PARENT_SCOPE)
      elseif(WIN32 OR CYGWIN)
        set(CMAKE_SERIF_FAMILIES "serif,windows" PARENT_SCOPE)
      else()
        set(CMAKE_SERIF_FAMILIES "serif,other" PARENT_SCOPE)
      endif()
    else()
      set(CMAKE_SERIF_FAMILIES "${value}" PARENT_SCOPE)
    endif()
  elseif("${type}" STREQUAL "mono")
    if("${value}" STREQUAL "default")
      if(APPLE)
        set(CMAKE_MONO_FAMILIES "monospace,apple" PARENT_SCOPE)
      elseif(WIN32 OR CYGWIN)
        set(CMAKE_MONO_FAMILIES "monospace,windows" PARENT_SCOPE)
      else()
        set(CMAKE_MONO_FAMILIES "monospace,other" PARENT_SCOPE)
      endif()
    else()
      set(CMAKE_MONO_FAMILIES "${value}" PARENT_SCOPE)
    endif()
  endif()
endfunction()
