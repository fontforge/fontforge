...
.. function:: open(filename[, flags])
   ...
   .. object:: hidewindow (16)
      ...
      Do not create a view window for this font even if the UI is active. Note:
      ...
      the bottom of the "Window" menu but choosing them will have no effect. If
      some fonts are not closed you may need to "force-quit" the application
      using your OS.
