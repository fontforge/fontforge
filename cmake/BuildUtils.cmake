...
function(set_font_family type value)
  if("${type}" STREQUAL "sans")
    if("${value}" STREQUAL "default")
      if(APPLE)
        set(FONTFORGE_SANS_FAMILIES "sans,apple" PARENT_SCOPE)
      elseif(WIN32 OR CYGWIN)
        set(FONTFORGE_SANS_FAMILIES "sans,windows" PARENT_SCOPE)
      else()
        set(FONTFORGE_SANS_FAMILIES "sans,other" PARENT_SCOPE)
      endif()
    else()
      set(FONTFORGE_SANS_FAMILIES "${value}" PARENT_SCOPE)
    endif()
  elseif("${type}" STREQUAL "serif")
    if("${value}" STREQUAL "default")
      if(APPLE)
        set(FONTFORGE_SERIF_FAMILIES "serif,apple" PARENT_SCOPE)
      elseif(WIN32 OR CYGWIN)
        set(FONTFORGE_SERIF_FAMILIES "serif,windows" PARENT_SCOPE)
      else()
        set(FONTFORGE_SERIF_FAMILIES "serif,other" PARENT_SCOPE)
      endif()
    else()
  ...
  elseif("${type}" STREQUAL "mono")
    if("${value}" STREQUAL "default")
      if(APPLE)
        set(FONTFORGE_MONO_FAMILIES "monospace,apple" PARENT_SCOPE)
      elseif(WIN32 OR CYGWIN)
        set(FONTFORGE_MONO_FAMILIES "monospace,windows" PARENT_SCOPE)
      else()
        set(FONTFORGE_MONO_FAMILIES "monospace,other" PARENT_SCOPE)
      endif()
    else()
