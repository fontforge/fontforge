...
# ========================================================
### Windows script folder: C:\Users\YourUsername\AppData\Roaming\FontForge\python\
### Linux\Mac script folder: ~/.config/fontforge/python/
# ========================================================
...
# 3. 使用快捷按键，各个自动置位。
# ========================================================
### Windows安装路径: C:\Users\用户名\AppData\Roaming\FontForge\python\
### Linux\Mac安装路径: ~/.config/fontforge/python/
# ========================================================
# 工具 -> 字形置位 -> 十五居一：
# Ctrl+小键盘. : 居中横
# Ctrl+小键盘0: 居中从
