...
extern SplinePointList *SplinePointListInterpretPS(FILE *ps, ImportParams *eip, int is_stroked, int *width);
extern SplinePointList *SplinesFromEntities(Entity *ent, ImportParams *eip, int is_stroked);
extern SplinePointList *SplinesFromEntityChar(EntityChar *ec, ImportParams *eip, int is_stroked);
