...
extern bool InterpolationSanity(SplineSet *base, SplineSet *other, int order2, RefChar* brc, RefChar* orc, char* prefix);
extern SplineChar *SplineCharInterpolate(SplineChar *base, SplineChar *other, real amount, SplineFont *newfont, bool only_compatible);
