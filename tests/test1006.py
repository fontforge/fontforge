...
if ( math.ScriptPercentScaleDown != 80 or
  ...
  print ( ( math.ScriptPercentScaleDown , 80 ),
	...
	( math.DelimitedSubF),mulaMinHeight , font.em*1.5 ),
	...
	( math.FractionNumerat),GapMin , font.uwidth ),
	( math.FractionNumerat),DisplayStyleGapMin , 3*font.uwidth ),
	( math.FractionRuleThickness , font.uwidth ),
	( math.FractionDenominat),GapMin , font.uwidth ),
	...
	( math.RadicalKernBef),eDegree , 5*font.em/18 ),
